...
beautiful.init("/home/cwage/.config/awesome/default/theme.lua")
...
--         end),
    ...
    awful.key({ modkey,           }, "\\", function () awful.util.spawn("xmms2 toggle") end),
...
mystatusbar = awful.wibox({ position = "right", screen = 1, ontop = false,
width = 80, height = 1 })
